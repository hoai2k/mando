...
export const POSES: Pose[] = [
  ...
  { id: 'saber1', name: 'Sabers 1 — right lead', lower: 'idleLower', upper: 'saber1', melee: true },
  { id: 'saber2', name: 'Sabers 2 — left lead', lower: 'idleLower', upper: 'saber2', melee: true },
  { id: 'saber3', name: 'Sabers 3 — cross slash', lower: 'idleLower', upper: 'saber3', melee: true },
