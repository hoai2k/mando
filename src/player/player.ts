...
const BLOCK_SINK = 16;
/**
 * Outer space, as the movement code has to decide it: the gravity scale at or
 ...
 * over a deck and 0.05 out in the open, blending across the eighteen metres
 * between — so this threshold is a *place* on that board rather than the whole
 * of it: true out among the platforms and under the void plane, false again a
 * dozen metres above something you could land on, which is exactly where the
 * pull should take over and set you down.
 */
