...
- **Weapons draw themselves.** X swings and RT fires, and whichever you press puts that weapon in your hands — no swap button, no dead trigger coming out of a combo. The D-pad picks *within* a slot (left: blades, right: guns) for a fighter carrying more than one, and every fighter carries both. Only the playable war beasts are melee-only.
