...
- **Up to 4-player split-screen co-op.** One shared enemy pool/wave state; per-player camera, HUD, health, fuel. If one player dies they respawn while a partner survives the wave; all down = defeat. Two players split top/bottom, three put two above a full-width third, four take a quadrant each.
